...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-xl border border-transparent px-4 py-2.5 text-center text-sm font-semibold leading-tight whitespace-normal break-words transition-[background-color,color,box-shadow,transform,border-color] duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-ring/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background aria-invalid:ring-destructive/30 dark:aria-invalid:ring-destructive/50 aria-invalid:border-destructive active:scale-[0.98]",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "min-h-8 gap-1.5 rounded-lg px-3 py-1.5 has-[>svg]:px-2.5",
        lg: "min-h-10 px-6 py-3 has-[>svg]:px-4",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
