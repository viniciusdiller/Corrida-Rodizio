      ...
      <div className="mx-auto max-w-3xl space-y-8">
        <div className="mb-6 flex items-center justify-between">
          <Button
            variant="outline"
            onClick={() => router.push("/")}
            className="gap-2 rounded-xl bg-background/90 font-semibold shadow-sm backdrop-blur"
          >
        ...
        <header className="space-y-3">
          ...
          <h1 className="text-3xl font-black text-foreground">{about.title}</h1>
          <p className="text-sm text-muted-foreground">{about.last_update}</p>
